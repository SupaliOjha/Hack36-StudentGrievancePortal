...
<form id="form1" runat="server"> 
    ...
    <asp:TextBox ID="EmailText" runat="server" placeholder="Enter Email ID" 
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Text="Doesn't Have Any Account?" ForeColor="White" class="msg"></asp:Label>
    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#000099" 
        Font-Bold="True" NavigateUrl="~/StudentRegistration.aspx">Sign Up Here</asp:HyperLink>
        <br />
        <br />
    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Red" class="invalid"></asp:Label>
        <br />
    </form>
    </div>
</body>
